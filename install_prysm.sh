...
# Import account
sudo ./prysm.sh validator accounts import --keys-dir=./validator_keys --accept-terms-of-use --pyrmont --wallet-password-file ./validator_keys/password.txt --wallet-dir /var/lib/prysm/validator --account-password-file ./validator_keys/password.txt

# Copy binaries to bin
sudo cp dist/*amd64 /usr/local/bin
